...
本文记录平台仓库当前锁定的直接 Python 依赖。Re3D 算法、模型权重、COLMAP、OpenMVS 等资源不在本仓库分发，其详细身份和更严格的非商业边界见 [Re3D 第三方声明](https://github.com/Timteapot/Re3D/blob/main/THIRD_PARTY_NOTICES.md)。
